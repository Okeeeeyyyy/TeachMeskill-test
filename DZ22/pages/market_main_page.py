...
from DZ22.Locators.basket_page import Basket
from DZ22.Locators.market_page import Market
...
class MarketPage(Base):
    ...
    def add_to_cart(self):
        self.click_element_by_index(
            Market.ADD_TO_CART, 0
        )  # кликаем по индексу, 0 это значит, что кликаем по первой карточке
